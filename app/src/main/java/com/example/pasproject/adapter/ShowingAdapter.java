...
public class ShowingAdapter extends RecyclerView.Adapter<ShowingAdapter.ItemMovieViewHolder> {

    private Context context;
    private List<ItemMovieModel> itemMovieModelList;

    public ShowingAdapter(Context context, List<ItemMovieModel> itemMovieAdapterList) {
